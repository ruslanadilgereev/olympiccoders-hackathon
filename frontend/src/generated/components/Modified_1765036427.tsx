        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
              <div className="bg-zinc-800 rounded-md p-4 border border-red-500">
              ...
              <div className="bg-zinc-800 rounded-md p-4 flex items-center justify-center border border-red-500">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-zinc-800 rounded-md p-4 border border-red-500">
                ...
                <div className="text-xs text-green-500">SAP ECC 6.0</div>
                <button className="text-xs text-blue-500">Add System</button>
              </div>
              <div className="bg-zinc-800 rounded-md p-4 border border-red-500">
                <div className="text-sm text-zinc-400">System ID:</div>
