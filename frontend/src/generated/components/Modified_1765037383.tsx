...
const ProjectScopeDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0b0b0d] text-gray-300 font-sans selection:bg-blue-500 selection:text-white">
      {/* Top Navigation Bar */}
      <header className="h-16 border-b border-red-600 flex items-center justify-between px-6 bg-[#0b0b0d]">
      ...
      <div className="px-8 py-8">
        <div className="flex justify-between items-start mb-8">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-[#1e293b] rounded flex flex-col items-center justify-center text-blue-400 border border-red-600">
          ...
          <div className="flex gap-3">
            <button className="flex items-center gap-2 px-4 py-2 border border-red-600 rounded text-xs font-medium hover:bg-gray-800 transition-colors">
        ...
        {/* Workflow Steps */}
        <div className="grid grid-cols-6 border border-red-600 rounded-sm overflow-hidden mb-10">
          {steps.map((step, idx) => (
            <div 
              key={idx} 
              className={`
                ...
                ${idx !== steps.length - 1 ? 'border-r border-red-600' : ''}
              `}
            >
          ...
          <div className="col-span-7">
            ...
            <div className="mb-10">
              <div className="flex justify-between items-center mb-4">
                ...
                <button className="flex items-center gap-1 px-3 py-1.5 border border-red-600 rounded text-[0.65rem] text-gray-400 hover:text-white hover:border-red-500 transition-colors">
                  <LayoutGrid className="w-3 h-3" />
                  VIEW SCOPE
                </button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {inScopeSystems.map((sys) => (
                  <div key={sys.id} className="bg-[#161618] p-4 rounded border border-red-600 hover:border-red-500 transition-colors group">
                    <div className="flex flex-col h-full justify-between gap-4">
                      ...
                      <div>
                        ...
                        <button className="w-full py-1.5 border border-red-600 rounded text-[0.6rem] font-bold tracking-wide text-gray-400 hover:text-red-400 hover:border-red-900/50 transition-colors uppercase">
                          Remove System
                        </button>
                      </div>
                    </div>
                ...
                {/* Add Placeholder */}
                <div className="border border-dashed border-red-600 rounded flex items-center justify-center min-h-[140px] cursor-pointer hover:border-red-500 hover:bg-gray-900/20 transition-colors">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {availableSystems.map((sys) => (
                  <div key={sys.id} className="bg-[#161618] p-4 rounded border border-red-600 hover:border-red-500 transition-colors">
                    <div className="flex flex-col h-full justify-between gap-4">
                      <div>
                        <div className="text-xs text-gray-500 mb-1">System ID:</div>
                        <div className="text-sm font-medium text-white">{sys.id}</div>
                      ...
                      <div>
                        <div className="text-xs text-gray-500 mb-1">Version:</div>
                        <div className="text-xs text-gray-300 mb-3">{sys.version}</div>
                        <button className="w-full py-1.5 bg-blue-600/10 border border-red-600 rounded text-[0.6rem] font-bold tracking-wide text-blue-400 hover:bg-blue-600 hover:text-white transition-colors uppercase">
                          Add System
                        </button>
                      </div>
                    </div>
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-2 gap-5">
                  <div className="space-y-1.5">
                    ...
                    <input 
                      type="text" 
                      defaultValue="P10" 
                      className="w-full bg-[#161618] border border-red-600 rounded px-3 py-2 text-sm text-white focus:outline-none focus:border-blue-500"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-xs text-gray-500">Default IMP Content</label>
                    <div className="relative">
                      <select className="w-full bg-[#161618] border border-red-600 rounded px-3 py-2 text-sm text-gray-400 appearance-none focus:outline-none focus:border-blue-500">
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <select className="w-full bg-[#161618] border-b-2 border-red-600 rounded-t px-3 py-2 text-sm text-white appearance-none focus:outline-none">
                        <option>SAP</option>
                      </select>
                      <ChevronDown className="absolute right-3 top-2.5 w-4 h-4 text-gray-500 pointer-events-none" />
                    </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <input 
                        ...
                        className="w-full bg-[#161618] border border-red-600 rounded px-3 py-2 text-sm text-gray-400 focus:outline-none focus:border-blue-500 pl-8"
                      />
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <select className="w-full bg-[#161618] border border-red-600 rounded px-3 py-2 text-sm text-white appearance-none focus:outline-none focus:border-blue-500">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className="w-1/2 bg-[#161618] border border-red-600 rounded px-3 py-2 text-sm text-white focus:outline-none focus:border-blue-500 pl-8"
                    />
                    <div className="absolute left-3 top-2.5 w-4 h-4 text-gray-500">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg>
                    </div>
