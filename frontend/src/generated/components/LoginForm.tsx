    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4 font-sans">
      ...
      <div className="w-full max-w-[340px] bg-white rounded-[2rem] shadow-[0_20px_40px_-10px_rgba(0,0,0,0.1)] p-8 relative">
        ...
        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <button 
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-full py-3.5 shadow-[0_10px_20px_-5px_rgba(37,99,235,0.4)] active:scale-[0.98] transition-all mt-2 text-sm"
          >
            Log In
          </button>
