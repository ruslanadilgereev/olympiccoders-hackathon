...
const Button = ({ children, variant = 'primary', className = '', icon: Icon, ...props }: any) => {
  ...
  const variants = {
    ...
    outline: "bg-transparent border border-green-500 text-gray-300 hover:bg-white/5",
    ghost: "bg-transparent hover:bg-white/5 text-gray-300",
    danger: "bg-transparent border border-green-500 text-gray-300 hover:bg-green-500/10",
    secondary: "bg-[#2A2D36] hover:bg-[#353842] text-white border border-green-500"
  };
  ...
  <div className="w-full">
    ...
    <div className="relative">
      <input 
        ...
        className="w-full bg-[#0f1115] border border-green-500 rounded p-2.5 text-sm text-gray-300 focus:outline-none focus:border-blue-500 placeholder-gray-600"
...
const SelectInput = ({ label, options, defaultValue }: any) => (
  <div className="w-full">
    ...
    <div className="relative">
      <select 
        className="w-full bg-[#0f1115] border border-green-500 rounded p-2.5 text-sm text-gray-300 focus:outline-none focus:border-blue-500 appearance-none"
        defaultValue={defaultValue}
      >
...
const SystemCard = ({ id, version, type = 'available' }: { id: string, version: string, type?: 'scope' | 'available' }) => (
  <div className="bg-[#16181d] border border-green-500 rounded p-4 flex flex-col gap-4">
    ...
    <div className="mt-auto">
      {type === 'scope' ? (
        <button className="w-full py-2 text-[10px] font-bold uppercase tracking-wide border border-green-500 rounded text-gray-400 hover:bg-green-500/10 transition-colors">
          Remove System
        </button>
      ) : (
...
const NavTab = ({ label, active = false, done = false }: any) => (
  <div className={`
    flex-1 py-3 px-4 text-xs font-medium uppercase tracking-wide border border-green-500 flex items-center justify-center gap-2 cursor-pointer transition-all
...
export default function ProjectScopeDashboard() {
  return (
    <div className="min-h-screen bg-[#0b0c10] text-gray-300 font-sans selection:bg-blue-500/30">
      {/* Top Navigation */}
      <nav className="h-16 border-b border-green-500 flex items-center justify-between px-6 bg-[#0f1115]">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="w-8 h-8 rounded-full bg-purple-600 flex items-center justify-center text-white text-xs font-bold border border-green-500">
            RK
          </div>
      ...
      {/* Header Section */}
      <header className="py-8 px-8 border-b border-green-500 bg-[#0b0c10]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="bg-[#1e293b] border border-green-500 rounded px-3 py-2 text-center">
      ...
      {/* Process Tabs */}
      <div className="flex w-full border-b border-green-500 overflow-x-auto">
      ...
      <main className="p-8 grid grid-cols-1 xl:grid-cols-12 gap-12">
        ...
        <div className="xl:col-span-7 space-y-10">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              {/* Add Placeholder */}
              <div className="border border-dashed border-green-500 rounded bg-[#0f1115]/50 flex flex-col items-center justify-center gap-2 min-h-[160px] cursor-pointer hover:bg-[#0f1115] transition-colors group">
        ...
        <div className="xl:col-span-5">
          <div className="bg-[#16181d] border border-green-500 rounded p-8">
