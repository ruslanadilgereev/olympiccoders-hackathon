...
const HistoryAnalysisPendingScreen = () => {
  const steps = [
  ...
  const systems = [
    { name: 'P01', status: 'Waiting', progress: 0 },
      ...
      <main className="p-8">
        ...
        <div className="bg-[#181818] p-6 mt-1">
          <div className="flex justify-between items-center mb-6">
            ...
            <button className="bg-[#DC2626] text-white px-4 py-2 rounded-md text-sm font-semibold">
              START ALL ANALYSIS
            </button>
          </div>
          
          <div className="rounded-lg overflow-hidden border border-[#27272A]">
            <div className="grid grid-cols-[1fr_1fr_3fr_2fr] items-center p-4 text-sm text-[#9CA3AF] bg-[#27272A]">
        ...
        <div className="flex justify-end mt-8">
          <button className="bg-[#2E3A87] text-white px-4 py-2 rounded-md text-sm font-semibold flex items-center space-x-2 hover:bg-[#3c4cb3]">
...
export default HistoryAnalysisPendingScreen;
