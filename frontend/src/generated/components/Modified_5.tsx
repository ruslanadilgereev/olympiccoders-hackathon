...
const GeneratedUI = () => {
  return (
    <div className="min-h-screen bg-[#02040a] text-white font-sans overflow-x-hidden">
      {/* Navbar */}
      <nav className="flex items-center justify-between px-8 py-4 border-b border-red-500">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-[#cc0000] rounded-full flex items-center justify-center font-bold text-lg border border-red-500">
            jivs
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-2 cursor-pointer">
            <div className="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center text-xs font-bold border border-red-500">
              RK
            </div>
      ...
      <main className="relative px-8 pb-20">
        ...
        <section className="relative z-10 pt-24 pb-16 max-w-2xl">
          ...
          <button className="bg-[#0066ff] hover:bg-blue-600 text-white px-8 py-3 rounded-md font-semibold text-sm flex items-center gap-2 transition-all border border-red-500">
        ...
        <section className="relative z-10 mb-16">
          ...
          <div className="flex gap-6 overflow-x-auto pb-4">
            ...
            {/* Card 1 */}
            <div className="min-w-[300px] h-[180px] rounded-xl overflow-hidden relative group border border-red-500">
              <img 
              ...
              <div className="absolute bottom-0 left-0 p-5">
                <div className="w-8 h-8 mb-3 rounded bg-cyan-500/20 flex items-center justify-center border border-red-500">
            ...
            <div className="min-w-[300px] h-[180px] rounded-xl overflow-hidden relative group border border-red-500">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent" />
              <div className="absolute bottom-0 left-0 p-5">
                <div className="w-8 h-8 mb-3 rounded bg-purple-500/20 flex items-center justify-center border border-red-500">
            ...
            {/* Card 3 (Active) */}
            <div className="min-w-[340px] h-[200px] -mt-2 rounded-xl overflow-hidden relative group shadow-2xl shadow-red-900/20 border border-red-500">
              <img 
              ...
              <div className="absolute top-5 left-5">
                 <div className="w-10 h-10 bg-red-900/80 backdrop-blur-sm rounded flex items-center justify-center border border-red-500">
              ...
              <div className="absolute bottom-0 left-0 p-6 w-full">
                ...
                <button className="bg-[#3b4eff] hover:bg-blue-600 text-white text-xs font-bold py-2 px-6 rounded shadow-lg shadow-blue-900/50 transition-all border border-red-500">
                  OPEN PROJECT
                </button>
              </div>
            </div>
        ...
        <section className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Discover Card 1 */}
            <div className="h-[200px] rounded-xl overflow-hidden relative group cursor-pointer border border-red-500">
              <img 
