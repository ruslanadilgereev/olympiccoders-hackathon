    ...
    <div className="min-h-screen bg-[#0c0c0e] text-gray-300 font-sans selection:bg-blue-500/30">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex justify-end">
          <button className="bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold py-3 px-6 rounded shadow-lg shadow-blue-900/20 flex items-center gap-2 transition-all uppercase tracking-wide">
